			...
			<?php foreach ($videos as $row) : ?>
				<div class="col-sm-4 col-md-4 col-lg-4">
					<div class="embed-responsive embed-responsive-21by9">
						<iframe title="<?= $row->video_title ?>" class="embed-responsive-item" src="<?= $row->video_link ?>" frameborder="0" height="100%" width="100%"></iframe>
					</div>
					<p style="color:chocolate"><?= $row->video_title ?> </h4>
				</div>
			<?php endforeach ?>
		</div>
	</div>
