...
<head>
	...
	<title>Tegra ONGD | Site web</title>
	<meta name="description"
		  content="Tegra Ongd est une Asbl de droit Congolais à caractère social, Communautaire et de développement, crée le 20 Mai 2009 à Lubumbashi dans la Province du Haut Katanga">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="generator" content="Tegra Ongd République Démocratique du Congo"/>
	<meta name="keywords"
		  content="Tegra ONGD, Tegra Ongd Lubumbashi, Ongd Tegra RDC, Tegra Ongd Haut Katanga Lubumbashi"/>
							...
							<div class="d-flex justify-content-between flex-wrap align-items-center">
								<div class="header-info-left">
									<ul>
										...
										<li><a href="mailto:contact@tegraond.org" class="__cf_email__"
											   data-cfemail="adc4c3cbc283949dedcec5ccdfc4d9c8df83cec2c0">[contact@tegraond.org]</a>
										</li>
									</ul>
								</div>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						...
						<div class="col-xl-2 col-lg-2">
							<div class="logo">
								<img src="<?= base_url() ?>assets/img/logo/logo.png" alt="Logo Tegra ONGD">
							...
							<div class="main-menu f-right d-none d-lg-block">
								<nav>
									<ul id="navigation">
										...
										<li><a href="<?= base_url() ?>about" class="">Apropos</a></li>
										<li><a href="#">Projets</a>
											<ul class="submenu">
										...
										<li><a href="<?= base_url() ?>activities/index">Actualités</a></li>
